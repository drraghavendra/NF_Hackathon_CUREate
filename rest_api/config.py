...
# FastAPI
PROJECT_NAME = os.getenv("PROJECT_NAME", "NF_FastAPI")
...
# Reader
READER_MODEL_PATH = os.getenv("READER_MODEL_PATH", "ktrapeznikov/biobert_v1.1_pubmed_squad_v2")
...
DEFAULT_TOP_K_RETRIEVER = int(os.getenv("DEFAULT_TOP_K_RETRIEVER", 6))
